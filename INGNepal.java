...
public class INGNepal implements ActionListener{
    ...
    public void report(){
        ...
        rcb = new JComboBox(year);
        cb1 = new JComboBox(month);
        cb2 = new JComboBox(day);
        rcb.setBounds(570,225,75,20);
        ...
        //for textfont
        Font tbtn = new Font("Arial",Font.BOLD, 15);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==appointfullbutton){
            ...
            try{
                ...
                year = rcb.getSelectedItem().toString();
                ...
                else if (full_staffName.getText().isEmpty() || full_Qualification.getText().isEmpty()||rcb.getSelectedItem().toString().isEmpty()||
